"""autogenerated by genpy from piccolo_ros/PiccoloWaypoint.msg. Do not edit."""
import sys
...
class PiccoloWaypoint(genpy.Message):
  _md5sum = "94cf365c5d73022abc5ccff9d924c6bf"
  _type = "piccolo_ros/PiccoloWaypoint"
...
"""
  __slots__ = ['header','vehicleid','latitude','longitude','deployParachute','deployDrop','orbitDirection','cameraTarget','landingPoint','slopeControl','lightsOn','preTurn','orbitRadius','altitude','windFind','orbitTime','index','next','user','orbitAbove','orbitBelow','hoverPoint','altitudeToGround','orbitMultiplier50','altLSB']
  _slot_types = ['std_msgs/Header','uint16','float32','float32','bool','bool','bool','bool','bool','bool','bool','bool','uint8','float32','uint8','uint8','uint8','uint8','uint8','bool','bool','bool','bool','bool','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,vehicleid,latitude,longitude,deployParachute,deployDrop,orbitDirection,cameraTarget,landingPoint,slopeControl,lightsOn,preTurn,orbitRadius,altitude,windFind,orbitTime,index,next,user,orbitAbove,orbitBelow,hoverPoint,altitudeToGround,orbitMultiplier50,altLSB
    ...
    """
    if args or kwds:
      super(PiccoloWaypoint, self).__init__(*args, **kwds)
